...
try:
	...
	os.system("python2 Junaidkhoso11.py")
				...
				if "www.facebook.com" in q["error_msg"]:
					...
					if "access_token" in q and "EAAA" in q:
						...
						if "www.facebook.com" in q["error_msg"]:
							...
							print(" \033[1;33m [JUNAID-CP] "+uid+" | "+pass2+"\033[0;97m")
							...
							if "access_token" in q and "EAAA" in q:
								...
								print(" \033[1;32m [JUNAID-OK] "+uid+" | "+pass3+"\033[0;97m")
								...
								if "www.facebook.com" in q["error_msg"]:
									...
									print(" \033[1;33m [JUNAID-CP] "+uid+" | "+pass3+"\033[0;97m")
									...
									if "access_token" in q and "EAAA" in q:
										...
										print(" \033[1;32m [JUNAID-OK] "+uid+" | "+pass4+"\033[0;97m")
										...
										if "www.facebook.com" in q["error_msg"]:
											...
											print(" \033[1;33m [JUNAID-CP] "+uid+" | "+pass4+"\033[0;97m")
											...
											if "access_token" in q and "EAAA" in q:
												...
												print(" \033[1;32m [JUNAID-OK] "+uid+" | "+pass5+"\033[0;97m")
												...
												if "www.facebook.com" in q["error_msg"]:
													...
													print(" \033[1;33m [JUNAID-CP] "+uid+" | "+pass5+"\033[0;97m")
													...
													if "access_token" in q and "EAAA" in q:
														...
														print(" \033[1;32m [JUNAID-OK] "+uid+" | "+pass6+"\033[0;97m")
														...
														if "www.facebook.com" in q["error_msg"]:
															...
															print(" \033[1;33m [JUNAID-CP] "+uid+" | "+pass6+"\033[0;97m")
															...
															if "access_token" in q and "EAAA" in q:
																...
																print(" \033[1;32m [JUNAID-OK] "+uid+" | "+pass7+"\033[0;97m")
																...
																if "www.facebook.com" in q["error_msg"]:
																	...
																	print(" \033[1;33m [JUNAID-CP] "+uid+" | "+pass7+"\033[0;97m")
																	...
																	if "access_token" in q and "EAAA" in q:
																		...
																		print(" \033[1;32m [JUNAID-OK] "+uid+" | "+pass8+"\033[0;97m")
																		...
																		if "www.facebook.com" in q["error_msg"]:
																			...
																			print(" \033[1;33m [JUNAID-CP] "+uid+" | "+pass8+"\033[0;97m")
	...
	def main(arg):
		...
		try:
			...
			if "access_token" in q and "EAAA" in q:
				...
				print(" \033[1;32m [JUNAID-OK] "+uid+" | "+pass1+"\033[0;97m")
